...
**Bookstore** is a website that allow users to add books with it's author and see list of books.
...
```sh
  git clone https://github.com/kazim110/bookstore-v2.git
```
...
- **What is this project?**
  ...
  - It's a  project of micoverse curriculum entitled Bookstore.
...
This project is [MIT](https://github.com/kazim110/bookstore-v2/blob/developmet/LICENSE) licensed.
